			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					<div class="panel-heading">
						<div class="row">
							<div class="col-xs-6">
								<a href="/Toto_list_final_project/ToDoListController/login" class="active" id="login-form-link">Login</a>
							</div>
							<div class="col-xs-6">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								...
								<form id="login-form" action="/Toto_list_final_project/controller/login" method="post" role="form" style="display: block;">
								...
								<form id="register-form" action="/Toto_list_final_project/SigninController/signin" method="post" role="form" style="display: none;">
									<div class="form-group">
